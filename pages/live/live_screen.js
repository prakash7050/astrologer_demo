...
const LiveScreen = () => {
  ...
  return (
    videoCall ? 
        <AgoraUIKit settings={{mode:1,role:2}} connectionData={connectionData} rtcCallbacks={callbacks} />
        :
        <Text style={{color:"black",textAlign:"center",alignItems:"center",borderWidth:2,width:100,margin:"40%"}} onPress={() => setVideoCall(true)}>Join</Text>
